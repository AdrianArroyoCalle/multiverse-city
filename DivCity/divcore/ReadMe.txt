========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: divcore 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL divcore.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación divcore.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado divcore.pch y un archivo de tipos 
